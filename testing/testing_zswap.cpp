...
int main( int argc, char** argv)
{
    ...
    // real_Double_t row_perf0 = MAGMA_Z_NAN, col_perf0 = MAGMA_Z_NAN;
    // real_Double_t row_perf1 = MAGMA_Z_NAN, col_perf1 = MAGMA_Z_NAN;
    // real_Double_t row_perf2 = MAGMA_Z_NAN, col_perf2 = MAGMA_Z_NAN;
    // real_Double_t row_perf4 = MAGMA_Z_NAN;
    // real_Double_t row_perf5 = MAGMA_Z_NAN, col_perf5 = MAGMA_Z_NAN;
    // real_Double_t row_perf6 = MAGMA_Z_NAN, col_perf6 = MAGMA_Z_NAN;
    // real_Double_t row_perf7 = MAGMA_Z_NAN;
    // real_Double_t cpu_perf  = MAGMA_Z_NAN;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
             * clBLAS / cuBLAS / Xeon Phi zswap, row-by-row (2 matrices)
             */
            ...
            time = magma_sync_wtime( opts.queue );
            magma_setvector( nb, sizeof(magma_int_t), ipiv, 1, d_ipiv(0), 1, opts.queue );
